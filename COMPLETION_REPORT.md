> ⛔ **무효 (2026-07-31 판정): 2026년 6월 초 MVP 스캐폴드 시점의 완성 보고서다.**
> 여기 적힌 파일 구조, API 5개, 컴포넌트 15개, "다음 단계" 목록은 현재 코드와 다르다
> (예: Header/Footer는 TopBar/GNB로 대체됐고, API 라우트는 실제 15개다).
> 현행 정본 = 같은 폴더 `CLAUDE.md`. 본문은 초기 설계 기록으로 보존한다.
