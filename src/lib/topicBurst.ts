...
const TOPIC_STOPWORDS = new Set([
  ...
  '이라며', '라며', '밝혔다', '말했다',
  // 복권·로또 (2026-09-07 추가). 9/6(토) 후보 1~4위를 로또 기사가 독식하고 TOP3에 2건이
  // 실렸다. 주말에만 몰려 나와 평소 대비 배율이 폭발하는데, 정작 경제 브리핑에 쓸 기사가 아니다.
  // ⭐관문(articleGate)이 아니라 여기서 막는 이유: '로또'가 든 기사 105개 중 상당수가
  //   「'로또 청약' 9만명 우르르」·「'로또 줍줍' LH가 매입」 같은 진짜 부동산 기사다(DB 실측).
  //   관문에 넣으면 그것들이 통째로 잘린다. 여기 넣으면 화제 점수만 못 받고 기사는 남으며,
  //   부동산 기사는 '청약'·'분양'으로 점수를 받아 영향이 없다.
  '로또', '복권', '당첨', '당첨금', '당첨번호', '당첨자', '명당',
])
